...
func (body *OrderParams) Validate() error {
	...
	validationErrors = validate.Parameter(body.WalletAddress, "WalletAddress", validate.CheckEthereumAddress, validationErrors)
...
func (body *AdditionalPlaceOrderParams) Validate() error {
	var validationErrors []error
	validationErrors = validate.Parameter(body.PrivateKey, "PrivateKey", validate.CheckPrivateKeyRequired, validationErrors)
	validationErrors = validate.Parameter(body.Maker, "Maker", validate.CheckEthereumAddress, validationErrors)
	return validate.ConsolidateValidationErorrs(validationErrors)
}
