...
// Valid indicates whether the value is a known member of the GetQuoteOutputRecommendedPreset enum.
func (e GetQuoteOutputRecommendedPreset) Valid() bool {
	switch e {
	case Custom:
		return true
	case Fast:
...
type QuoterControllerBuildQuoteTypedDataParams struct {
	...
	Fee *big.Int `url:"fee,omitempty" json:"fee,omitempty"`
	...
	IsPermit2 bool `url:"isPermit2,omitempty" json:"isPermit2,omitempty"`
