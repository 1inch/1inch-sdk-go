...
type SettlementPostInteractionDataFusion struct {
...
func NewSettlementPostInteractionDataFusion(data SettlementSuffixDataFusion) (*SettlementPostInteractionDataFusion, error) {
	...
	return &SettlementPostInteractionDataFusion{
		Whitelist:          whitelist,
...
func DecodeFusion(data string) (SettlementPostInteractionDataFusion, error) {
	bytes, err := hexutil.Decode(data)
	if err != nil {
		return SettlementPostInteractionDataFusion{}, errors.New("invalid hex string")
	}
	...
	var bankFee *big.Int
	var integratorFee *IntegratorFeeFusion
	var customReceiver common.Address

	if flags.Bit(0) == 1 {
		bankFee, err = iter.NextUint32()
		if err != nil {
			return SettlementPostInteractionDataFusion{}, err
		}
	}
...
func (spid SettlementPostInteractionDataFusion) Encode() (string, error) {
...
func (spid SettlementPostInteractionDataFusion) CanExecuteAt(executor common.Address, executionTime *big.Int) bool {
...
func (spid SettlementPostInteractionDataFusion) IsExclusiveResolver(wallet common.Address) bool {
