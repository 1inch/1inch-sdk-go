...
// Valid indicates whether the value is a known member of the AssetProvider enum.
func (e AssetProvider) Valid() bool {
	switch e {
	case OPENSEA:
		return true
	case POAP:
...
// Valid indicates whether the value is a known member of the GetNftsByAddressParamsChainIds enum.
func (e GetNftsByAddressParamsChainIds) Valid() bool {
	switch e {
	case N1:
		return true
	case N10:
