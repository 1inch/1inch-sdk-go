...
import (
	...
	"github.com/1inch/1inch-sdk-go/v5/sdk-clients/balances"
)
...
func main() {
	...
	response, err := client.GetBalancesAndAllowancesOfCustomTokensByWalletAddress(ctx, balances.BalancesAndAllowancesOfCustomTokensByWalletAddressParams{
