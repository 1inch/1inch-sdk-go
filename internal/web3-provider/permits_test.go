...
func TestTokenPermit(t *testing.T) {
	...
	testcases := []struct {
		...
		},
		{
			...
			amount:        big.NewInt(100000),
			deadline:      1713457338,
			// Must work, if you will remove DomainSeparator and PermitTypeHash it will be correct, but with them the signature is failing
		...
		// not ready yet, must be finished
		//{
