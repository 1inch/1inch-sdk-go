...
- **User-Agent header**: API requests now report the actual SDK version from build info; the header was pinned to `v3.0.0`. Only exact release versions (vX.Y.Z) are reported; builds from unreleased commits report `unknown`.
